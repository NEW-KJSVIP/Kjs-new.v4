...
cd /usr/bin
wget https://raw.githubusercontent.com/NEW-KJSVIP/Kjs-projeck/main/Bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/NEW-KJSVIP/Kjs-projeck/main/Bot/kyt.zip
unzip kyt.zip
